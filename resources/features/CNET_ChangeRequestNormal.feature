Feature: CNET CHANGE REQUEST AUTOMATION SCENARIOS
  ...
  Scenario Outline: CNET_ChangeRequest
    ...
    | admin  | Cnet345$   | Change      | *CAROL-IBM        | 1 - Critical  | High      | 1 - High    | QA            | QA 1        | Assess | Sample Testing   | Testing Sample          | Successful     | Success         | Authorize      | Schedule       | Implement      | Review      | Closed      |
