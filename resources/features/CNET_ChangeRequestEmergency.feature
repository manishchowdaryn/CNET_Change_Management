Feature: CNET CHANGE REQUEST AUTOMATION SCENARIOS
  ...
  Scenario Outline: CNET_ChangeRequest
    ...
    Examples: 
      ...
      | admin  | Cnet345$   | Change      | *CAROL-IBM        | 1 - Critical  | High      | 1 - High    | CAB Approval  | Howard Johnson | Authorize | Sample Testing   | Testing Sample          | Successful     | Success         | Authorize      | Schedule       | Implement      | Review      | Closed      |
